...
def get_filters():
    ...
    invalid_inputs = "Invalid input. Please try again with the mentioned city names" 
    
    print('Hey there! Let\'s now explore some US bikeshare data!')
